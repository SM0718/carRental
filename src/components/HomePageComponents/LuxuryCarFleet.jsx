    ...
    function SampleNextArrow(props) {
        ...
        return (
          <div
            className={`absolute justify-center items-center transition duration-500 hidden group-hover:flex hover:bg-white cursor-pointer
             right-10 sm:right-[100px] md:right-[125px] lg:right-[350px] top-6 sm:top-44 z-50 size-14 rounded-full bg-[#f5b754]`}
            onClick={onClick}
          ><Right sw={'1'}/></div>
        );
      }
      ...
      function SamplePrevArrow(props) {
        ...
        return (
          <div
            className={`absolute justify-center items-center transition duration-500 hidden group-hover:flex hover:bg-white cursor-pointer
           left-10 sm:left-[100px] md:left-[125px] lg:left-[350px] top-6 sm:top-44 z-50 size-14 rounded-full bg-[#f5b754]`}
            onClick={onClick}
          ><Left sw={'1'}/></div>
        );
      }
...
<div className="slider-container w-screen h-[500px]">
      <Slider {...settings}>
      {
                    ...
                    <div className='max-w-5xl h-[400px] rounded-2xl px-4 sm:px-6'>
